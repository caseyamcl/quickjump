...
<body>
  ...
  <div id='top_header' class='clearfix'>
		<h1><a href='/' title='Hompage'><?php echo strip_tags($conf['title'])?></a></h1>
  ...
  <div id='main_pane'>
		...
		<div id='main_pane_header'>	        
			...
			<form id='search' method='get' accept-charset='utf-8' action='/doku.php/'>
				<input type="hidden" value="search"  name="do"/>
				<input type='text' id="navSearch" value='search' name="id" accesskey="f" /> <!-- <input class='button' type='submit' value='&raquo;' />-->
			</form>
		</div>    
  ...
  <div id="footer">
    ...
    <p>
      ...
      <br />Copyright (c) <?php echo(date('Y'));?> STEER Partnership Project
    </p>
  </div>
